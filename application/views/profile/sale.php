              ...
              <section class="section-balance ">
               ...
               <div class="bungkus " style="">
                  <div class=" mb-2 mt-3 balance">
                      ...
                      <input class="text-right rounded-0 border-light" type="text" readonly placeholder="$<?= $balance[0]['SUM(harga)'] ?>" value="$ <?= $balance[0]['SUM(harga)'] / 2?>" >
                  </div>
                  <div class=" mb-3 balance">
                      <div class="text-white  d-block-inline text-center float-left" style="">
                        <span>PAYOUT</span>
                      </div>
                      <input class="text-right rounded-0 border-light" type="text" style="" placeholder="$ 500"  >
